...
export const locations: Space[] = [
  {
    ...
    description: "Massive research center at the University of Toronto, focused on arts, social sciences & government.",
  ...
  },
  {
    ...
    description: "Supports undergraduate programs in the humanities and social sciences, including specialized Victoria College programs.",
  ...
  },
  {
    ...
    description: "The largest science and health science academic library with a collection consisting primarily of material on the sciences.",
  ...
  },
  {
    value: "knox-college",
    label: "Knox College",
    description: "Knox College is a diverse community committed to the ideals of intellectual engagement, critical inquiry, and integrity, as well as to the principles of excellence, fairness, and respect for all people.",
  ...
  },
  {
    ...
    description: "The University College Library offers a large study space with lots of natural light, 20 computers, a group study room, and is also the home of the UC Writing Centre.",
    ...
    metadata: {
      amenities: ["WiFi", "Outlets", "Printing", "Water Fountains", "Computers"],
  ...
  },
  {
    ...
    description: "The Myhal Centre is designed to foster collaboration between researchers, students, industry partners and alumni, sparking the exchange of new ideas and catalyzing innovation.",
  ...
  },
  {
    ...
    description: "The Bahen Centre for Information Technology in Toronto, ON is a facility dedicated to advancing research and education in the field of information technology.",
  ...
  },
  {
    ...
    description: "The Sidney Smith Commons is a an academic resource to help Arts & Science students through their undergraduate journey.",
  ...
  },
  {
    ...
    description: "The Temerty Faculty of Medicine at the University of Toronto is at the centre of one of North America’s largest biomedical research, education and clinical care networks.",
  ...
  },
  {
    value: "music-library",
    label: "Music Library",
    description: "The Music Library features articles, scores, encyclopedias, dissertations, and streaming media related to the study of music.",
  ...
  },
  {
    ...
    description: "The library has collections covering the decorative arts as they relate to ceramic objects manufactured in England, France, Italy, Austria and Germany.",
  ...
  },
  {
    ...
    description: "Rotman School of Management in Toronto offers innovative business education, integrative thinking, leadership development, and prime access to networking in Canada’s dynamic economic and cultural hub.",
  ...
  },
  {
    ...
    description: "Emmanuel College, within the University of Toronto, offers theological education emphasizing social justice, interfaith dialogue, and access to rich academic and urban resources.",
  ...
  },
  {
    value: "ivey-library",
    label: "Ivey Library",
    description: "Ivey Library, at Emmanuel College in the University of Toronto, provides specialized theological resources, study spaces, and support, fostering academic excellence in a vibrant environment.",
  ...
  },
  {
    ...
    description: "The Eberhard Zeidler Library, located within the University of Toronto’s Daniels Building, offers extensive resources in architecture, landscape architecture, and urban design, supporting academic excellence.",
  ...
  },
  {
    ...
    description: "The Noranda Earth Sciences Library at the University of Toronto offers extensive resources in geology and environmental science, supporting research and learning in Earth Sciences.",
  ...
  },
  {
    ...
    description: "The Engineering and Computer Science Library at the University of Toronto offers extensive resources and study spaces, supporting engineering and computer science research and education.",
  ...
  },
  {
    ...
    description: "The John M. Kelly Library at the University of St. Michael’s College, University of Toronto, offers extensive humanities and social sciences collections, supporting diverse academic programs.",
  ...
  },
  {
    ...
    description: "The A.D. Allen Chemistry Library at the University of Toronto offers extensive resources and study spaces, supporting chemistry research and education.",
  ...
  },
  {
    ...
    description: "The Mathematical Sciences Library at the University of Toronto offers extensive resources and study spaces, supporting research and education in mathematics and statistical sciences.",
  ...
  },
  {
    value: "innis-college",
    label: "Innis College",
    description: "Innis College, established in 1964 at the University of Toronto, offers programs in Cinema Studies, Urban Studies, and Writing and Rhetoric, fostering a vibrant academic community.",
  ...
  },
  {
    ...
    description: "The John W. Graham Library, serving Trinity and Wycliffe Colleges at the University of Toronto, offers extensive theological resources and study spaces, supporting academic excellence.",
  ...
  },
  {
    value: "regis-college",
    label: "Regis College",
    description: "Regis College, the Jesuit Faculty of Theology at the University of Toronto, offers programs in theology and ministry, emphasizing Jesuit traditions and academic excellence.",
  ...
  },
  {
    ...
    description: "The Bora Laskin Law Library at the University of Toronto supports legal research and education with extensive collections and study spaces.",
  ...
  },
  {
    ...
    description: "The Dentistry Library at the University of Toronto offers extensive dental resources and study spaces, supporting research and education in dental sciences.",
  ...
  },
  {
    ...
    description: "The UTSU Student Commons, located at 230 College Street, serves as a central hub for University of Toronto students. It offers study spaces, meeting rooms, lounges, and a café, fostering community engagement and providing resources for student activities.",
  ...
  },
  {
    value: "oise-library",
    label: "OISE Library",
    description: "The OISE Library at the University of Toronto is Canada’s largest academic education library, supporting teacher training, graduate studies, and research in education.",
